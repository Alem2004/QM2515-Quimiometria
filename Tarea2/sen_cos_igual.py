...
def main():
    ...
    diff = math.isclose(seno_aprox, coseno_aprox, rel_tol=1e-6)
    
    # Imprimimos resultados
    if diff:
        print(f"El seno y el coseno de {angulo}° son aproximadamente iguales.")
    else:
        print(f"El seno y el coseno de {angulo}° no son iguales.")
